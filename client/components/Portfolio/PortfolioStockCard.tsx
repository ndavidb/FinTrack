...
const PortfolioStockCard: React.FC<StockPortfolioPerformance> = ({companyName, website, purchasePrice, performance} : Props) => {
    return (
        <div className="bg-white p-4 rounded border border-gray-200 hover:shadow-md transition-shadow">
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="text-xs lg:text-sm">
                    ...
                    <p className={`font-semibold ${performance >= 0 ? 'text-green-500' : 'text-red-500'}`}>
